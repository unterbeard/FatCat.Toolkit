...
public static class TestExtensions
{
	...
	public static UnorderedCallAssertion ShouldMatch<T>(this IAssertConfiguration configuration, Action<T> matcher) { return configuration.MustHaveHappened(1, Times.OrMore); }

	private static T Matches<T>(this IArgumentConstraintManager<T> manager, Func<T, bool> predicate) { return manager.Matches(predicate, x => x.Write("Test Matches fails")); }
}