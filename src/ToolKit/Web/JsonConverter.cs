...
public class JsonConverter : IJsonConvert
{
	...
	public T? DeserializeObjectWithTypeHandling<T>(string json) { return DeserializeObjectWithTypeHandling<T>(json, Array.Empty<Newtonsoft.Json.JsonConverter>()); }
	...
	public string SerializeObject(object value) { return SerializeObject(value, Formatting.None, false); }
