...
internal static class FromKeyedServicesAttributeExtensions
{
	...
	public static object ResolveParameter(
		this FromKeyedServicesAttribute attribute,
	...
	public static bool CanResolveParameter(
		this FromKeyedServicesAttribute attribute,
		ParameterInfo parameter,
		IComponentContext context
	)
	{
		// Adapter for FromKeyedServicesAttribute to work like Autofac.Features.AttributeFilters.KeyFilterAttribute.
		return context.ComponentRegistry.IsRegistered(
			new Autofac.Core.KeyedService(attribute.Key, parameter.ParameterType)
		);
	}
}
