...
public partial class AutofacServiceProvider
	: IServiceProvider,
		...
		IAsyncDisposable
{
	...
	public object GetKeyedService(Type serviceType, object serviceKey)
	{
		...
		else
		{
			try
			{
				...
				when (ex.InnerException is KeyTypeConversionException conversionException)
			{
	...
	public bool IsService(Type serviceType) =>
		_lifetimeScope.ComponentRegistry.IsRegistered(new TypedService(serviceType));
